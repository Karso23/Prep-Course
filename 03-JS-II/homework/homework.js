...
function tablaDelSeis(){
  ...
  let array = []; // se deja en blanco el corchete cuando no sabes ni que valores ni de que longitud es el array

  for (i=0; i<11; i++){
    array.push(6*i);
  } return array; //devuelvo la variable array por que ejercicio me pide que devuelva el array
}
